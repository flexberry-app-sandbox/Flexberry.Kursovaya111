...
namespace IIS.Kursovaya11
{
    ...
    public class ОказКонсульт : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya11.Услуга fПредостУслуга;
        
        private IIS.Kursovaya11.РасчетОстВрем fРасчетОстВрем;
        ...
        public virtual IIS.Kursovaya11.Услуга ПредостУслуга
        {
            get
            {
                ...
                IIS.Kursovaya11.Услуга result = this.fПредостУслуга;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovaya11.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Kursovaya11.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Kursovaya11.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказКонсультE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказКонсультE", typeof(IIS.Kursovaya11.ОказКонсульт));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказКонсульт : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovaya11.DetailArrayOfОказКонсульт members)

        // *** End programmer edit section *** (IIS.Kursovaya11.DetailArrayOfОказКонсульт members)
        ...
        /// </summary>
        public DetailArrayOfОказКонсульт(IIS.Kursovaya11.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказКонсульт), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Kursovaya11.ОказКонсульт this[int index]
        {
            get
            {
                return ((IIS.Kursovaya11.ОказКонсульт)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovaya11.ОказКонсульт dataobject)
        {
